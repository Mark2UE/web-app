...
<section class="zenBody d-flex flex-column justify-content-center" style="height:80vh;">

    <div class="container custom-margin-x-10  mb-5">
        <div class="fs-3"><span class="highlight-red bold">Forgot</span>/password</div>
